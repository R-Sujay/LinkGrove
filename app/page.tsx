...
hover:from-blue-600 hover:to-purple-700 text-lg px-8 py-6
h-auto"
              >
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed">
                  Make your link page uniquely yours with custom themes, colors,
                  and layouts that match your brand.
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-llblur-sm border border-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50"
              >
